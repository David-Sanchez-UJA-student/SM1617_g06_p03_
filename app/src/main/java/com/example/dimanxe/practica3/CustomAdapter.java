 ...
 */
    ...
    public class CustomAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.tv1.setText("Billete:\t "+bils.get(position).getOrigen()+"-"+bils.get(position).getDestino());
            holder.tv2.setText("Fecha: \t"+bils.get(position).getFecha()+"\t"+bils.get(position).getHora());
            holder.tv3.setText("Id del Billete: \t"+bils.get(position).getIdbillete()+"\t Precio:XXXX");
            rowView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // TODO Auto-generated method stub
                    Toast.makeText(context, "You cliked "+bils.get(position).getIdbillete(), Toast.LENGTH_LONG).show();
                }
            });
            return rowView;
        }
